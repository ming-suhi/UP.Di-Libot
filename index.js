 ...
 */
const CENTER_COORDINATE = [14.656126099446102, 121.06746536690618];
/**
 ...
 */
function validateTimelineObject(timelineObject) {
...
function* getCoordinates(data) {
    ...
    for (const timelineObject of data) {
        ...
        if (timelineObject.activitySegment) {
            ...
            if (!((_a = activitySegment.simplifiedRawPath) === null || _a === void 0 ? void 0 : _a.points)) {
                continue;
            }
            for (const point of (_b = activitySegment.simplifiedRawPath) === null || _b === void 0 ? void 0 : _b.points) {
...
const ui = document.querySelector("#prompt");
fileInput.addEventListener('change', async () => {
    ...
    // Process the files
    const timelineObjects = new Array();
